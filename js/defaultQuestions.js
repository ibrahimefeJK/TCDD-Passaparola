...
g.PassaparolaDefaults={letters:rows.map(function(r){return r[0];}),questions:rows.map(function(r){return{id:r[0],letter:r[0],question:r[1],acceptedAnswers:[r[2]],enabled:true};}),settings:{title:'TCDD EĞİTİM MERKEZİ',subtitle:'PASSAPAROLA YARIŞMASI',durationSeconds:240,lastThirtyWarning:true,adminPin:'1234'}};
})(window);
